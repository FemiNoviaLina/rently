<x-base-layout>
    <x-base-body selected="Guide">
        <div class="flex rounded-md mt-24 justify-center">
            <a href="{{ url('/guide') }}" class="py-2 px-10 font-bold text-lilac-100 bg-white rounded-l-sm border border-lilac-100 hover:bg-lilac-300 hover:text-white transition duration-500">
            ...
            <a href="#" aria-current="page" class="py-2 px-10 font-bold text-white bg-lilac-100 rounded-r-sm border border-lilac-100 transition duration-500">
        ...
        <div class="mt-4 mb-20 px-20 py-10 bg-white shadow-md rounded-lg w-full max-w-7xl m-auto">
            <ol class="relative border-lilac-100 ">                  
                <li class="mb-10 ml-4">
                    ...
                    <p class="mb-4 text-base font-normal ml-4">Must have SIM C (for motorbike rental) or SIM A (for car rental) which is still valid and can show it when handing over the vehicle.</p>
                </li>
                <li class="mb-10 ml-4">
                    ...
                    <p class="mb-4 text-base font-normal ml-4">Must comply with all applicable vehicle rental procedures.</p>
                </li>
                <li class="mb-10 ml-4">
                    ...
                    <p class="mb-4 text-base font-normal ml-4">Must be willing to be photographed with the rental vehicle, for data collection purposes.</p>
                </li>
                <li class="mb-10 ml-4">
                    ...
                    <p class="mb-4 text-base font-normal ml-4">Delivery and pick-up service hours are 06.00 - 21.00 WIB. Outside of service hours you can subject to postage of Rp. 50.000,-.</p>
                </li>
                <li class="mb-10 ml-4">
                    ...
                    <p class="mb-4 text-base font-normal ml-4">The amount of fuel at the end of use / at the time of return must be the same as the fuel at the beginning of use.</p>
                </li>
                <li class="mb-10 ml-4">
                    ...
                    <p class="mb-4 text-base font-normal ml-4">It is not allowed to rent a motorbike to be taken out of the Malang area, inform Rent.ly and if you violate the provisions, you will be subject to a fine of Rp. 150.000,-</p>
                </li>
                <li class="mb-10 ml-4">
                    <div class="absolute w-8 h-8 bg-gray-200 rounded-full text-center font-bold text-white pt-1 -left-4 border border-lilac-100 bg-lilac-100">7</div>
                    <p class="mb-4 text-base font-normal ml-4">All crimes will be reported to the police and will be dealt with strictly according to applicable law.</p>
                </li>
                <li class="mb-10 ml-4">
                    <div class="absolute w-8 h-8 bg-gray-200 rounded-full text-center font-bold text-white pt-1 -left-4 border border-lilac-100 bg-lilac-100">8</div>
                    <p class="mb-4 text-base font-normal ml-4">Overtime is valid only for the first 1 hour and is charged Rp. 10,000,-. If it is more than 1 hour, the rate will be charged for the next day.</p>
                </li>
            </ol>
        </div>
    </x-base-body>
